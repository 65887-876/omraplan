...
const Step4 = ({ formData, handleNestedChange, locationMakkah, handleLocationChangeMakkah, handleLocationInputChange, generateMapLink }) => {
  return (
    <div className="flex flex-col justify-center items-center md:px-0 px-4 sm:mt-4">
      <label className="sm:text-h3 text-h4 text-center w-[100%] font-medium text-neutral-13">Informations sur l’hôtel à Makkah</label>
      ...
      <div className="flex flex-col gap-6 w-full md:w-[800px]">
        <div className="flex flex-col gap-2">
          ...
          <input
            type="text"
            name="nom"
            value={formData.hotelMakkah.nom}
            onChange={(e) => handleNestedChange(e, 'hotelMakkah')}
        ...
        <div className="flex flex-col gap-2 relative">
          <label className="text-sm font-bold text-neutral-13">Distance du Kaaba</label>
          <input
            type="text"
            name="distanceKaba"
            value={formData.hotelMakkah.distanceKaba}
            onChange={(e) => handleNestedChange(e, 'hotelMakkah')}
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              name="emplacement"
              value={locationMakkah ? generateMapLink(locationMakkah) : formData.hotelMakkah.emplacement}
              onChange={(e) => handleLocationInputChange(e, 'hotelMakkah')}
        ...
        <div className="flex flex-col gap-2">
          <div className="w-full h-64 sm:h-[240px] md:h-[260px] bg-white border border-gray-300 rounded-md overflow-hidden">
            <MapSelector location={locationMakkah} setLocation={handleLocationChangeMakkah} />
          </div>
        </div>
      </div>
    </div>
...
Step4.propTypes = {
  ...
  locationMakkah: PropTypes.object,
  handleLocationChangeMakkah: PropTypes.func.isRequired,
