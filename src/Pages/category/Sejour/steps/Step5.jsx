...
const Step5 = ({ handleFileChange, previewPhotos, handleRemovePhoto }) => {
  const [isPhotoDeCouvertureUploaded, setIsPhotoDeCouvertureUploaded] = useState(previewPhotos.length > 0);
            ...
            <div className="w-full h-full overflow-hidden">
              ...
              <button
                ...
                onClick={(event) => {
                  ...
                  handleRemovePhoto(0);
                  setIsPhotoDeCouvertureUploaded(previewPhotos.length > 1);
                }}
              >
