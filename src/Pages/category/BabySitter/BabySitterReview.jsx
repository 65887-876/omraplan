...
const LeftSection = ({ previewPhotos, settings }) => {
  return (
    <div className="w-full md:w-[624px] h-[450px] bg-white p-8 rounded-2xl">
      ...
      <h1 className="text-h4 py-8 font-plus-jakarta font-bold text-neutral-13 text-left">Baby-sitter</h1>
    </div>
  );
};
...
const BabySitterReview = ({ formData, previewPhotos, setFormData, showPhoneNumber, setShowPhoneNumber }) => {
    ...
    <div className="flex flex-col justify-between items-center mt-8 p-0 gap-4">
      <div className="flex flex-col items-center p-0 w-full">
        ...
        <p className="font-plus-jakarta font-medium text-lg md:text-xl my-2 leading-6 text-center text-[#667085]">
          Voici ce que les parents verront. Assurez-vous que tout est correct.
        </p>
      </div>
