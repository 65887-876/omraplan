...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col py-20 md:flex-row items-center sm:gap-10 justify-between px-4 md:px-20 overflow-hidden bg-gradient-to-br from-yellow-200 via-yellow-50 to-yellow-50">
      <div className="w-full sm:pt-0 md:w-1/2 flex flex-col gap-6 md:pb-0">
        <p className="sm:font-volkhov font-plus-jakarta w-[100%] md:w-[85%] text-[40px] sm:text-[64px]  font-bold text-neutral-13">
          Organisez votre <span className="sm:font-bold font-extrabold text-[#987306] ">OMRA 2025</span> et partez au meilleur prix !
        </p>
        <p className="text-[28px]  font-plus-jakarta font-bold text-primary-7">
